...
Original file is located at
    https://colab.research.google.com/drive/1gqjxyTsd3psWo7QFIx5o6qUptmf_3C8r

####Condensed Index (DA MODIFICARE)
...
#Jacopo's data path
#DATA_PATH = '/content/drive/MyDrive/Fds/FDS'
#Irene's Datapath
#DATA_PATH = '/content/drive/MyDrive/input/fds-pokemon-battles-prediction-2025'
#Rosa's Datapath
#DATA_PATH = '/content/drive/MyDrive/IV_anno_I_semestre/Fundamentals of Data Science/Theory - Ingro/Lightning&Pokemom/fds-pokemon-battles-prediction-2025'
...
#print("META MODELLO")
#print("="*100)
#print(results_df.iloc[-1:].set_index('Model').round(4))
